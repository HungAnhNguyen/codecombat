...
#    meta_keywords: "CodeCombat, python, javascript, Coding Games"
     meta_description: "Học code thông qua trò chơi lập trình. Học Python, JavaScript và HTML khi bạn giải đố và học cách tạo trò chơi và trang web của riêng mình."
#    meta_og_url: "https://codecombat.com"
     become_investor: "trở thành nhà đầu tư trong CodeCombat"
#    built_for_teachers_title: "A Coding Game Built with Teachers in Mind"
     built_for_teachers_blurb: "Dạy code cho trẻ em thường khiến giáo viên thấy choáng. CodeCombat giúp tất cả nhà giáo dạy học sinh code bằng cả Python lẫn JavaScript - hai ngôn ngữ lập trình thông dụng nhất. Với một chương trình giáo dục toàn diện bao gồm 6 đơn vị bài học Khoa học máy tính và các đơn vị củng cổ bài học thông qua phát triển game và web, các bạn nhỏ sẽ hoàn thành một chặng đường tuyệt vời từ những cú pháp đơn giản tới các chương trình phức tạp."
     built_for_teachers_subtitle1: "Khoa học máy tính - Computer Science"
     built_for_teachers_subblurb1: "Bắt đầu với khóa học miễn phí  Giới thiệu về Khoa học máy tính, học sinh có thể làm chủ khái niệm code lõi như là vòng lặp while/for, các hàm, thuật toán."
